...
class PostDetails(mixins.RetrieveModelMixin, mixins.DestroyModelMixin, mixins.UpdateModelMixin, mixins.CreateModelMixin, generics.GenericAPIView):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        return HttpResponse('agha nashod')
